...
<!--                    </li>-->
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="javascript:void(0)" v-on:click="user_dropdown=!user_dropdown" id="navbarDropdownProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="material-icons">person</i>
                            <p class="d-lg-none d-md-block">
                                Account
                            </p>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" v-bind:class="{'show':user_dropdown}" aria-labelledby="navbarDropdownProfile">
